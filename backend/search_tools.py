...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for doc, meta in zip(results.documents, results.metadata):
            ...
            # Only add source if we haven't seen this lesson before
            if source_key not in seen_sources:
                seen_sources.add(source_key)
                
                # Try to get lesson link if this is a specific lesson
                lesson_link = None
                if lesson_num is not None:
...
class CourseOutlineTool(Tool):
    """Tool for retrieving course outlines with title, link, and complete lesson list"""
    ...
    def execute(self, course_title: str) -> str:
        ...
        # Resolve course name using the same logic as CourseSearchTool
